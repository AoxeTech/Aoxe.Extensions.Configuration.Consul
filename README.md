# Aoxe.Extensions.Configuration.Consul

English | [简体中文](README-zh_CN.md)

---

Let the consul as a configuration source, include several configuration sources and several parsers (Json / Xml / Ini / Toml / Yaml).
